...
class Kitti360Dataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        poses_p_left = (
            [  ## IMU(pose) -> Camera -> World : backprojection (https://www.cvlibs.net/datasets/kitti-360/documentation.php)
        ...
        data = {
            ...
            "target": rgbs,
            "radii": radii,
            "multloss": torch.zeros((sample["rays_o"].shape[0], 1)),
            "normals": torch.zeros_like(sample["rays_o"]),
        }
