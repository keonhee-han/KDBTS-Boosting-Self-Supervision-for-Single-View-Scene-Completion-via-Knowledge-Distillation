...
class NeRFRenderer(torch.nn.Module):
    ...
    def composite(self, model, rays, z_samp, coarse=True, sb=0):
        ...
        with profiler.record_function("renderer_composite"):
            ...
            if "BEVNet" == model.__class__.__name__:        ##
                rgbs, invalid, sigmas, state_dict = model(points, coarse=coarse)        ## Taking all 3D points
            ...
            elif use_viewdirs:        ## for IBRNet input for the model
                dim1 = K
                ...
                for pnts in split_points:
                    if "BTSNet" == model.__class__.__name__:        ##
