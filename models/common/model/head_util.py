from .multi_view_head import MultiViewHead, SimpleMultiViewHead, MultiViewHead2, MultiViewHead3, DensityHead_BEV, make_attn_layers
...
def make_head(conf, d_in: int, d_out: int):
    ...
    elif head_type == "DensityHead_BEV":
        head = DensityHead_BEV.from_conf(conf["args"], d_in, d_out)
